...
- turning decisions into execution plans;
- creating operational memory;
- giving compliance and leadership a reviewable decision trail.

## Narrative

Avoid leading with "AI".

Lead with the operational failure:
...
Use `examples/decision-trace-demo.json` and the dashboard output to show the whole decision lifecycle in one screen.
